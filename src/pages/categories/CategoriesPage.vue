...
export default {
  ...
  data() {
    return {
      ...
      selectedCategory: '',
      categories: [
        { id: 1, name: 'Electronics', description: 'Latest gadgets and electronics.', image: 'https://via.placeholder.com/300x200?text=Electronics', link: '#' },
        { id: 2, name: 'Clothing', description: 'Trendy fashion wear for all ages.', image: 'https://via.placeholder.com/300x200?text=Clothing', link: '#' },
        { id: 3, name: 'Home Appliances', description: 'Quality appliances for your home.', image: 'https://via.placeholder.com/300x200?text=Home+Appliances', link: '#' },
        { id: 4, name: 'Beauty & Health', description: 'Skincare, makeup, and wellness products.', image: 'https://via.placeholder.com/300x200?text=Beauty+%26+Health', link: '#' },
      ],
    };
  },
  computed: {
