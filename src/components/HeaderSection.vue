...
.bg-neutral {
  background-color: #333333 !important; /* Dark gray background for the navbar */
  border-bottom: 2px solid #444444; /* Slightly lighter gray bottom border */
  padding: 10px 0;
}
...
.logo {
  ...
  padding-left: 15px; /* Padding for better spacing */
  display: flex; /* To display text and image horizontally */
...
.navbar-nav .nav-item .nav-link {
  color: #d1d1d1 !important; /* Light gray color for links */
  font-size: 16px;
  font-weight: 500;
...
.navbar-nav .nav-item .nav-link:hover {
  color: #ff9f00 !important; /* Orange color on hover for contrast */
  text-decoration: underline;
}

/* Navbar active link styling */
.navbar-nav .nav-item .nav-link.active {
  color: #ff9f00 !important; /* Orange color for active link */
  font-weight: 600;
}
...
@media (max-width: 768px) {
  ...
  .navbar-nav .nav-item {
    margin: 10px 0; /* Increased spacing for mobile view */
  }
  .navbar-toggler {
    border-color: #ff9f00; /* Orange border for toggler button */
  }
  .navbar-toggler-icon {
    background-color: #ff9f00; /* Orange icon for toggler */
  }
}
...
@media (max-width: 768px) {
  .logo-text {
    font-size: 1.2rem; /* Slightly smaller text on mobile devices */
  }
  .logo-icon {
